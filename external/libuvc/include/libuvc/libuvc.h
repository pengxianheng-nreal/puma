...
typedef struct uvc_frame {
  ...
  /** camera header package has the first package received time*/
  uint32_t cam_sof;
...
typedef void (uvc_frame_copyframe_t)(uint8_t *src, uint8_t *dst, uint32_t data_bytes, uint32_t width, uint32_t height, uint32_t bytes_per_pixel);
...
uvc_error_t uvc_wrap_sys_device(
    uvc_context_t *ctx, int64_t sys_dev,
    uvc_device_t **dev,
    uvc_device_handle_t **devh);
...
uint16_t uvc_get_len(uvc_device_handle_t *devh);

void uvc_get_cur(uvc_device_handle_t *devh);
void uvc_set_cur(uvc_device_handle_t *devh);

uvc_error_t uvc_write_sccb(uvc_device_handle_t *devh, uint8_t ch, uint8_t slave_address, int32_t address, uint8_t write_data);
uvc_error_t uvc_write_sccb_retry(uvc_device_handle_t *devh, uint8_t ch, uint8_t slave_address, int32_t address, uint8_t write_data, int retry);
uvc_error_t uvc_read_sccb(uvc_device_handle_t *devh, uint8_t ch, uint8_t slave_address, int32_t address, uint8_t *ret_data);

uvc_error_t uvc_write_register(uvc_device_handle_t *devh, int32_t address, uint8_t value);
uvc_error_t uvc_read_register(uvc_device_handle_t *devh, int32_t address, uint8_t *ret_data);
